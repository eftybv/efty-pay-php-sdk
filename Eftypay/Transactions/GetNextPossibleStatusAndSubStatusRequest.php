...
/**
 * GetNextPossibleStatusAndSubStatusRequest contains the request details for getting the next possible status.
 *
 * Generated from protobuf message <code>eftypay.transactions.GetNextPossibleStatusAndSubStatusRequest</code>
 */
class GetNextPossibleStatusAndSubStatusRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * transactionId contains the transaction ID to check the next possible status for.
     *
